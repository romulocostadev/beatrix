  ...
  const dataSourceTableGroup = [
    {
      ...
      title161: '1014612193',
      title172: '179719 - João da Silva',
      title183: '91330712 242259A:PRETO 2',
      title194: 'Tinta',
      title205: 'Make & Pack',
      title216: 'Pesagem',
      status27: [
    ...
    },
    {
      ...
      title161: '1014612194',
      title172: '773720 - Mario Barbosa',
      title183: '91330712 242259A:PRETO 2',
      title194: 'Verniz',
      title205: 'Make & Pack',
      title216: 'Homogenização',
      status27: [
        <Content3Row2Column71>
          <TagStatus1>
    ...
    },
    {
      ...
      title161: '1014612196',
      title172: '879722 - Flávio Augusto',
      title183: '91330712 242259A:PRETO 2',
      title194: 'Tinta',
      title205: 'Make & Pack',
      title216: 'Envase',
        ...
        <TableGroup dataSource={dataSourceTableGroup}>
          ...
          <ColumnTableGroup
            ...
            onFilter={(value, record: any) =>
              record.title161.indexOf(value) === 0
            }
          />
          <ColumnTableGroup
            title="Cliente"
            ...
            width="221.5712890625px"
            onFilter={(value, record: any) =>
              record.title172.indexOf(value) === 0
            }
          />
          <ColumnTableGroup
            title="Produto"
            ...
            width="221.5712890625px"
            onFilter={(value, record: any) =>
              record.title183.indexOf(value) === 0
            }
          />
          <ColumnTableGroup
            title="Categoria"
            ...
            width="221.5712890625px"
            onFilter={(value, record: any) =>
              record.title194.indexOf(value) === 0
            }
          />
          <ColumnTableGroup
            title="Tipo"
