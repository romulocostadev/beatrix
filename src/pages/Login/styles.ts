...
import Vector14840549090881Image from './assets/1521_133502.png' 
...
export const InputFormItem3 = styled(GenericFormItem)`
`;

export const InputLabelVertical3 = styled.div`
height: 20px;
width: 304px;
display: flex;
box-sizing: border-box;
...
align-items: center;
`;
export const InputLabel3 = styled(GenericText)`
        margin: 0px;
      width: 57px;
`;

export const InputFormItem4 = styled(GenericFormItem)`
`;

export const InputLabelVertical4 = styled.div`
height: 20px;
width: 304px;
display: flex;
box-sizing: border-box;
...
align-items: center;
`;
export const InputLabel4 = styled(GenericText)`
      margin: 0px;
    width: 102px;
`;
...
export const CreateaAccount1 = styled.div`
height: 500px;
width: 400px;
display: flex;
box-sizing: border-box;
...
align-items: flex-start;
`;
export const Vector14840549090881 = styled.div`
height: 24px;
width: 126px;
box-sizing: border-box;
  background: url(${Vector14840549090881Image});
  background-repeat: no-repeat;
`;
