...
<ColumnMateriaisTable title='Código' dataIndex='codigo10' key='codigo10' align='left'filters={[{text: '30000806', value: '30000806'},{text: '30226125', value: '30226125'},{text: '30537820', value: '30537820'},{text: 'Total', value: 'Total'},]}width='97px'onFilter={(value, record: any) => record.codigo10.indexOf(value) === 0 } /> 
<ColumnMateriaisTable title='Por (%)' dataIndex='por11' key='por11' align='left'width='98px' /> 
<ColumnMateriaisTable title='Descrição' dataIndex='descricao12' key='descricao12' align='left'width='531.5px' /> 
<ColumnMateriaisTable title='Quantidade Pedida' dataIndex='quantidadePedida13' key='quantidadePedida13' align='left'filters={[{text: '50 Kg', value: '50 Kg'},{text: '2,6 Kg', value: '2,6 Kg'},{text: '5,5 Kg', value: '5,5 Kg'},{text: '58,1 Kg', value: '58,1 Kg'},]}width='171px'onFilter={(value, record: any) => record.quantidadePedida13.indexOf(value) === 0 } /> 
<ColumnMateriaisTable title='Quantidade Real' dataIndex='quantidadeReal14' key='quantidadeReal14' align='left'filters={[{text: '-', value: '-'},{text: '0 Kg', value: '0 Kg'},]}width='155px'onFilter={(value, record: any) => record.quantidadeReal14.indexOf(value) === 0 } /> 
<ColumnMateriaisTable title='Adições / Motivo' dataIndex='adicoesMotivo15' key='adicoesMotivo15' align='left'width='531.5px' /> 
        </MateriaisTable>
      </Body3>
    </Card02>
    <Card021    >
